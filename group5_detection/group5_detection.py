...
def render_lidar_on_image(pts_velo, orig_img, calib, img_width, img_height, visualize=True):
    ...
    projected_grid = np.zeros_like(img).astype(np.float)
...
def segment_bb_frustum_from_projected_pcd(bb_list, projected_pointcloud, projected_grid, calib, labels=[], visualize=True, masks = None, orig_img = None):
    """
